...
public class NotificationService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        SharedPreferences prefs = getSharedPreferences(MY_PREFS_NAME, User.MODE_PRIVATE);
        if (!prefs.getBoolean("notif", true) && remoteMessage.getData().get("message").contains("est proche de vous")) {
